...
const firstDiceDOM = document.querySelector('.dice-0');
const secondDiceDOM = document.querySelector('.dice-1');
...
rollDiceButton.addEventListener('click', () => {
    const { firstDice, secondDice } = rollDice();
    if (firstDice !== 1 && secondDice !== 1) {
        currentPlayer.stats.roundScore += firstDice + secondDice;
    } else {
...
holdButton.addEventListener('click', () => {
    ...
    if (currentPlayer.stats.globalScore >= 100) {
